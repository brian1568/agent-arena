...
def predict_move(game_state: GameState):
    ...
    if game_state.direction.x == 1:
        dummy_game.direction = Direction.RIGHT
    elif game_state.direction.x == -1:
        dummy_game.direction = Direction.LEFT
    elif game_state.direction.y == 1:
        dummy_game.direction = Direction.DOWN
    elif game_state.direction.y == -1:
        dummy_game.direction = Direction.UP
